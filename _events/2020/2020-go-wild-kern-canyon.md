...
For the Keyesville event on Saturday, see [Go Wild! Kern Canyon (Keyesville) {% include common/icon.html icon="link" %}](/events/2020-go-wild-kern-canyon-2/)
...
**Location**: [BLM Staging Area along Keyesville Road {% include common/icon.html icon="location" %}](https://goo.gl/maps/5R1fe2ryB1okRjeh8)
